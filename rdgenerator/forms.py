...
class GenerateForm(forms.Form):
    ...
    version = forms.ChoiceField(
        ...
        initial='1.4.3',
        help_text=mark_safe("If a build fails, let me know. Start a issue on GitHub: <a href='https://github.com/airtau/creator/issues' style='color: #007bff; font-weight: bold; text-decoration: underline;'>Click here to report an issue</a>")
    )
